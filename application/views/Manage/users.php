								 ...
								 <div class="form-row">
								    ...
								    <div class="form-row">
										...
										<div class="valid-feedback-set">
	        								document: Passbook, Photo Id. </br>(Allowed file types : jpg,jpeg,png,pdf &nbsp; Max: 1024*768, size:10 MB) 
	      								</div>
										</div>
										...
										<div class="valid-feedback-set">
	        								document: Addressproof. </br>(Allowed file types : jpg,jpeg,png,pdf &nbsp; Max: 1024*768, size:10 MB) 
	      								</div>
										</div>
										...
										<div class="valid-feedback-set">
	        								document: Photo Id </br>(Allowed file types : jpg,jpeg,png,pdf &nbsp; Max: 1024*768, size:10 MB) 
	      								</div>
										</div>
	  ...
	  var ConfigUser = function () {
         ...
         //    		},
            ...
            if (showtd1['user_id'] == usrid) {
                ...
                <?php if(permsn_access(57,'ACTION')){ ?>
                ...
                <?php if(permsn_access(56,'ACTION')){ ?>
                ...
                <?php if(permsn_access(59,'ACTION')){ ?>
                ...
                <?php if(permsn_access(55,'ACTION')){ ?>
                            ...
                            if (data.error == 0) {
                                ...
                                $.each(document, function (k, v) {
                                    ...
                                    if ($.isEmptyObject(v) === true) {
                                        ...
                                        str += '</div>';
                                        str += '<span>(Allowed file types : jpg,jpeg,png,pdf &nbsp; Max: 1024*768, size:10 MB)</span></div></form></td>';
                                ...
                                $('.aprvd_rjctd_chng_doc').click(function (e) {
                                    ...
                                    if (documnt_array[row] != undefined) {
                                        if (documnt_array[row].id == doc_id) {
                                            ...
                                            fl += '</div>';
                                            fl += '<span>(Allowed file types : jpg,jpeg,png,pdf &nbsp; Max: 1024*768, size:10 MB)</span></div></form>';
