...
margin-top: 10px;
    ...
    <div class="col-lg-10">
        <div class="beneficiary-list">
            <div class="width-100 mb-3 bord-bottom gray-header" id="first_title">
              ...
              <button class="btn btn-primary  mr-10"  id="PlanAdd">Add Plan</button>
                    ...
                    <!--div class="row" id="AddDivButton" style="">
                        <div class="col-lg-12">
                            <button class="btn btn-primary  mr-10" style="float: right;" id="PlanAdd">Add Plan</button>
                        </div>
                    </div-->
             <div  id="PlanViewTable">
                 <div class="table-responsive">
                    ...
                    <table class="table datatables">
                        <thead class="thead-blue">
                          ...
                          <!--   <table class="table datatable-basic" id="PlanListTable">
                ...
                render: function (data, type, full, meta) {
...

                 {
                     ...
                     "orderable": false,
                      ...
                      "render": function ( data, type, full, meta ) {
                          return '<a data-plan="' + full.plan_id + '" id="Plan_Edit" class="btn btn-info white-txt">Edit</a> <a data-plan="' + full.plan_id + '" id="Plan_EditPlan" class="btn btn-info white-txt">Edit Service Rates</a> <a data-plan="' + full.plan_id + '" id="Plan_View" class="btn btn-info white-txt">View</a> <a data-plan="' + full.plan_id + '" id="Plan_SlabServiceRates" class="btn btn-info white-txt">Edit Slab Rates</a>';
                        }
                    },
                    ...
                    str+='</div>';
                                ...
                                $.each(serviceArr, function (k, v) {
                                    ...
                                    if (v.service_id in PlanService) {
                                        ...
                                        str += '<td><span class="ServiceName" id="EditPlanService_ServiceName' + v.service_id + '" data-service="' + v.service_id + '">' + v.service_name + ' (' + v.code + ')</span></td>';
                                        ...
                                        $.ajax({
                                            ...
                                            if (response)
                                            {
                                                ...
                                                } else if (response.error == 2)
                                                {
                                                    ...
                                                    $('#PlanServiceEdit').html('').hide();
                                                    $('#PlanViewTable').show();
                                                    $('#AddDivButton').show();
                                                    $('#PlanListTable').DataTable().ajax.reload();
                                                }
                                                la.ladda('stop');
                                            }
                                            la.ladda('stop');
                            ...
                            } else if (response.error_data == 2)
                            {
                                ...
                                if (response.data.length > 0) {
                                    $.each(response.data, function (k, v) {
                                        ...
                                        str += '<tr>';
                                        str += '<td>' + v.service_name + ' (' + v.code + ')</td>';
                        ...
                        if (response)
                        {
                            ...
                            } else if (response.error_data == 2)
                            {
                                ...
                                $.each(response.data, function (k4, v4) {
                                    slab += '<option value="' + v4.PlanServiceConfig + '">' + v4.service_name + ' (' + v4.code + ')</option>';
                                });
                                slab += '</select>';
                                slab += '</div>';
                        ...
                        if (response)
                        {
                            ...
                            } else if (response.error == 2)
                            {
                                ...
                                $.each(serviceArr, function (k, v) {
                                    ...
                                    str += '<td><span class="ServiceName" id="AddPlanService_ServiceName' + v.service_id + '" data-service="' + v.service_id + '">' + v.service_name + ' (' + v.code + ')</span></td>';
