                ...
                <!-- <section class="transaction-history-wrp"> -->
                    <div class="panel-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 transaction-history-wrp table-responsive">
...
<script>
 var PAYMENTREQUEST = function () {
    ...
    var Mode = {'IMPS': 'IMPS', 'NEFT': 'NEFT', 'CASH': 'CASH', 'RTGS': 'RTGS', 'CHEQUE': 'CHEQUE', 'OTHERS': 'OTHERS'};

        var bankOpr = {};

        var bankNameDefined = function () {
            $.ajax({
                url: 'FundTransfer/Bank_fr_dffrnt_role', 
                type: "POST",
                dataType: 'json',
        ...
        var oTable = $('#PaymentRequestList').DataTable({
                "processing": true,
                "ajax": {
                    url: "FundTransfer/PaymentRequestList",
                    type: 'post',
            ...
            if (params.valid == true) {
                ...
                $.ajax({
                    ...
                    if (response){
                        ...
                        toastr.error('Something went wrong due to technical issue');
                    }
                });
            }
        });
